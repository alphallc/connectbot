 ...
 * -e class org.alpha-llc.sshit.HostListActivityTest \
 * org.alpha-llc.sshit.tests/android.test.InstrumentationTestRunner
 */
public class SettingsActivityTest extends
		ActivityInstrumentationTestCase2<SettingsActivity> {

	public SettingsActivityTest() {
		super("org.alpha-llc.sshit", SettingsActivity.class);
	}
