...
package org.alphallc.sshit.transport;
...
import org.alphallc.sshit.R;
import org.alphallc.sshit.bean.HostBean;
import org.alphallc.sshit.bean.PortForwardBean;
...
import org.alphallc.sshit.service.TerminalManager.KeyHolder;
import org.alphallc.sshit.util.HostDatabase;
...
//		pubkey.setType(PubkeyDatabase.KEY_TYPE_IMPORTED);
	...
	/* (non-Javadoc)
	 * @see org.alphallc.sshit.transport.AbsTransport#usesNetwork()
	 */
	@Override
