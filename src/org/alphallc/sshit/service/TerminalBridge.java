...
package org.alphallc.sshit.service;
...
import org.alphallc.sshit.TerminalView;
...
import org.alphallc.sshit.transport.AbsTransport;
import org.alphallc.sshit.transport.TransportFactory;
...
public class TerminalBridge implements VDUDisplay {
	public final static String TAG = "sshIt.TerminalBridge";
	...
	/**
	 * Downloads the specified remote file to the local sshIt folder.
	...
	public void captureScreen() {
			...
			path = new File(dir, "sshIt-" + date + ".png");
			try {
				dir.mkdirs();
