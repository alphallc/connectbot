...
package org.alpha-llc.sshit.transport;
...
import org.alpha-llc.sshit.R;
import org.alpha-llc.sshit.bean.HostBean;
import org.alpha-llc.sshit.bean.PortForwardBean;
...
import org.alpha-llc.sshit.service.TerminalManager.KeyHolder;
import org.alpha-llc.sshit.util.HostDatabase;
...
public class SSH extends AbsTransport implements ConnectionMonitor, InteractiveCallback, AuthAgentCallback {
	...
	private static final String TAG = "sshIt.SSH";
...
//		pubkey.setType(PubkeyDatabase.KEY_TYPE_IMPORTED);
	...
	/* (non-Javadoc)
	 * @see org.alpha-llc.sshit.transport.AbsTransport#usesNetwork()
	 */
	@Override
