...
package org.alpha-llc.connectbot.transport;
...
import org.alpha-llc.connectbot.R;
import org.alpha-llc.connectbot.bean.HostBean;
import org.alpha-llc.connectbot.bean.PortForwardBean;
...
import org.alpha-llc.connectbot.service.TerminalManager.KeyHolder;
import org.alpha-llc.connectbot.util.HostDatabase;
		...
		if (HostDatabase.PORTFORWARD_LOCAL.equals(portForward.getType())) {
			...
			try {
				lpf = connection.createLocalPortForwarder(
						new InetSocketAddress("0.0.0.0", portForward.getSourcePort()),
...
//		pubkey.setType(PubkeyDatabase.KEY_TYPE_IMPORTED);
	...
	/* (non-Javadoc)
	 * @see org.alpha-llc.connectbot.transport.AbsTransport#usesNetwork()
	 */
	@Override
